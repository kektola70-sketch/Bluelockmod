...
@Mod("bluelock") // Это ID мода, должен совпадать с mods.toml
public class BlueLockMod {

    // Реестр предметов
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, "bluelock");
